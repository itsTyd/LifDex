            ...
            <div className="title-bar">
                <div className="title-bar-wrapper">
                    ...
                    <div className="app-buttons">
                        ...
                        <div className="titlebar-btn maximize" onClick={() => this.onClick('maximize')}>
                            <svg name="TitleBarMaximize" aria-hidden="false" width="12" height="12" viewBox="0 0 12 12">
                                {!isMaximized ? 
                                    (<>
                                        ...
                                        <line x1="10" y1="1" x2="10" y2="10" className="line-style" />
                                        <line x1="1" y1="10" x2="10" y2="10" className="line-style" />
                                    </>) : 
                                        (<>
                                            ...
                                            <line x1="1" y1="10" x2="8" y2="10" className="line-style" />
                                            
                                            <line x1="2" y1="1" x2="10" y2="1" className="line-style" />
                                            <line x1="3" y1="1" x2="3" y2="2" className="line-style" />
                                            <line x1="10" y1="0" x2="10" y2="8" className="line-style" />
